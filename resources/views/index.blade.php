...
<!-- body -->
<div class="page-body">
    <div class="container-xl" style="max-width: fit-content;">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-10">
                                            <div class="form-group">
                                                <input type="text" name="cari_data" id="cari_data" class="form-control" 
                                                    placeholder="Cari Data" value="{{ Request('cari_data') }}">
                                            </div>
                                        </div>
